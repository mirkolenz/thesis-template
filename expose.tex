...
Short introduction to the concepts that are necessary for the
remainder of the exposé.
...
This section builds on the introduction, but you should go into more
detail since the foundations are now known.

\section{Related Work}\label{sec:related-work}
Describe how others tackled the described problem or which works have
similar goals.
...
Ideally, include a few working hypotheses that will be investigated
in your thesis (e.g., in your experimental evaluation).
